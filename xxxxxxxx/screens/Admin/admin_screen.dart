...
import 'package:gestion_propinas/screens/Admin/Propinas/estadisticas_propinas_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 31, 98, 154), // Color del AppBar
      ),
      body: Padding(
